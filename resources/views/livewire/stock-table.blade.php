<div>
        ...
        <div class="bg-white rounded-xl shadow p-4 flex flex-row gap-4 items-center md:flex-col md:items-start">
            <div class="w-16 h-16 bg-primary p-3 rounded-full flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" class="w-10 h-10 text-white">
                ...
                <p class="text-xs text-gray-500">Barang dengan stok < 100</p>
                        ...
                        <div class="mt-2 md:mt-4">
                            <p class="text-3xl font-bold text-gray-900">
                                ...
                                return $item->stock && $item->stock->stock < 100; })->count() }}
                            </p>
    ...
    <div class="mb-4 flex flex-col md:flex-row gap-3">
        ...
        <div class="flex-1">
            <div x-data="{xShow: @entangle('query').live}" class="relative">
                ...
                <input wire:model.live.debounce.300ms="query" type="text" id="search-stock"
                ...
                <button type="button" x-show="xShow" @click="$wire.set('query', '')"
    ...
    <div class="bg-white rounded-2xl shadow-md overflow-hidden">
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            ...
                            @elseif($item->stock && $item->stock->stock < 100) <span
                        ...
                        @role('inventaris', 'admin', 'dev')
                        <td class="px-4 py-3 text-center">
                            <button type="button" wire:click="openReduceStockModal({{ $item->id }})"
                    ...
                    @empty
                    <tr>
                        <td colspan="{{ $this->colspan }}" class="text-center p-8 text-gray-500">
                            @if ($query || $filterType)
        ...
        <div class="overflow-x-auto w-full">
            ...
            <div class="mt-3 flex items-center justify-center gap-2 py-4">
                ...
                <button
                    class="px-3 py-2 rounded-xl border border-primary bg-white shadow-sm text-sm text-primary font-semibold">
                    {{ $page }}
                </button>
                @else
    ...
    <div class="fixed inset-0 bg-black/30 flex items-center justify-center p-4 z-50" wire:click="closeStockModals">
