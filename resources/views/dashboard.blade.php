                ...
                <div
                    ...
                    <span x-data="{ modalIsOpen: false }">
                        ...
                        <div x-cloak x-show="modalIsOpen" x-transition.opacity.duration.200ms
                            ...
                            x-transition.opacity role="dialog" aria-modal="true" aria-labelledby="defaultModalTitle">
                            <!-- Modal Dialog -->
                                            ...
                                            <table class="min-w-max w-full text-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="px-4 py-3">
                                                            {{
                                                            \Carbon\Carbon::parse($staff->todayAttendance->attendance_date,
                                                            'Asia/Jakarta')->format('d F Y') }}
                                                        </td>
                                            ...
                                            <table class="min-w-max w-full text-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-4 py-3">
                                                            {{
                                                            optional(optional($delivery->hasMistake)->reportedBy)->display_name
                                                            ?? 'Tidak ada' }}
                                                        </td>
                                                        ...
                                                        <td class="px-4 py-3">
                                                            ...
                                                            ? \Carbon\Carbon::parse($delivery->hasMistake->reported_at,
                                                        ...
                                                        <td class="px-4 py-3">
                                                            ...
                                                            ?
                                                            \Carbon\Carbon::parse($delivery->hasMistake->deliveryMistakeConfirmation->confirmed_at,
                                                            'Asia/Jakarta')->format(
                                                            'd F Y H:i',
                                                            ) . ' WIB'
                                                            : 'Belum dikonfirmasi' }}
                                    ...
                                    <div class="px-4 mt-8 mb-4">
                                        ...
                                        <div class="mt-2 grid grid-cols-12">
                                            ...
                                            <div
                                                ...
                                                <img src="{{ $item->image }}" class="w-[40px]" alt="Foto item">
                                                <div>
